...
-  We are going to include `rte_mbuf.h` for memory management.
   ...
   -  Read DPDK Docs regarding `mbuf` [here](https://doc.dpdk.org/guides/prog_guide/mbuf_lib.html)
-  [A good read about general concepts here](https://www.dpdk.org/blog/2019/08/21/memory-in-dpdk-part-1-general-concepts/)
...
-  We will use function `rte_eth_rx_queue_setup()`
   ...
   -  Read more [here](https://doc.dpdk.org/api/rte__ethdev_8h.html#a36ba70a5a6fce2c2c1f774828ba78f8d)
...
-  We will use function `rte_eth_tx_queue_setup()`
   ...
   -  Read more [here](https://doc.dpdk.org/api/rte__ethdev_8h.html#a796c2f20778984c6f41b271e36bae50e)
...
-  You can look at the code [here](https://github.com/IbrahimShahzad/dpdk-learning)
-  [Checkout the DPDK documentation as well.](https://www.dpdk.org/)